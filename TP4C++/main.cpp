...
int trianglepossible(int tab1[3],int tab2[3],int tab3[3])
{
    ...
    else cout<<"Triangle possible!!!"<<endl;
}
...
int righttriangle(int tab1[3],int tab2[3],int tab3[3])
{
       ...
       if( (tab1[0]*tab2[0]+tab1[1]*tab2[1]+tab1[2]*tab2[2])==0 || (tab1[0]*tab3[0]+tab1[1]*tab3[1]+tab1[2]*tab3[2])==0 || (tab3[0]*tab2[0]+tab3[1]*tab2[1]+tab3[2]*tab2[2])==0)
